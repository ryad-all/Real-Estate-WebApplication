...
const SearchForm = () => {
  return (
        <div className="w-full mt-4 border border-gray-300 p-6 grid grid-cols-1 gap-6 bg-white shadow-lg rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2 border border-gray-200 p-2 rounded">
              ...
              <div className="flex border rounded bg-gray-300 items-center p-2">
                ...
                >
                  <path
                    className="heroicon-ui"
                    d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zM5.68 7.1A7.96 7.96 0 0 0 4.06 11H5a1 1 0 0 1 0 2h-.94a7.95 7.95 0 0 0 1.32 3.5A9.96 9.96 0 0 1 11 14.05V9a1 1 0 0 1 2 0v5.05a9.96 9.96 0 0 1 5.62 2.45a7.95 7.95 0 0 0 1.32-3.5H19a1 1 0 0 1 0-2h.94a7.96 7.96 0 0 0-1.62-3.9l-.66.66a1 1 0 1 1-1.42-1.42l.67-.66a7.96 7.96 0 0 0 13 8.84v5a1 1 0 0 1-2 0v-5.84a7.96 7.96 0 0 0-1.62-3.9l-.66.66a1 1 0 0 1-1.42 1.42l.67-.66a7.96 7.96 0 0 0-12.16-2.12z"
                />
                </svg>
                <input
                  type="text"
